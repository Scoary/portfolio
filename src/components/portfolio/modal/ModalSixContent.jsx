  ...
  return (
    <div className="slideshow">
      <figure>
        ...
        <figcaption>
          <h3>site statique pour une association</h3>
          <div className="row open-sans-font">
            ...
            <div className="col-12 mb-2">
              ...
              <span className="ft-wt-600 uppercase">HTML, CSS, Framework : Bootstrap</span>
            </div>
            {/* End .col */}
            <div className="col-12 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://la-jeunesse-chaumontaise.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  www.la-jeunesse-chaumontaise.netlify.app/
                </a>
              </span>
            </div>
            <div className="col-12 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://github.com/Scoary/lajeunessechaumontaise-flavien-groslevin"
                  target="_blank"
                  rel="noreferrer"
                >
                  www.github.com/Scoary/lajeunessechaumontaise-flavien-groslevin
                </a>
              </span>
            </div>
            {/* End .col */}
